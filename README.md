...
Built with Claude (Anthropic) as a demo for exploring how agentic AI can augment the user research workflow.

## Demo

[Live Demo →](https://research-pipeline-jszqwp8rqc29rnplvdlbfy.streamlit.app/)
...
- [Claude](https://anthropic.com) (claude-sonnet-4-5) — LLM backbone for all three agents
